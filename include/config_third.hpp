...
constexpr const std::size_t B1           = 256;                        // 128 for GW
constexpr const dll::unit_type HT1       = dll::unit_type::RELU1;      // BINARY for GW
...
constexpr const std::size_t B2           = 256;                        // 128 for GW
constexpr const dll::unit_type HT2       = dll::unit_type::RELU6;      // BINARY for GW
...
const auto rate_0 = [](weight& value) { value = 1e-4; }; //0.1 * value for GW
const auto rate_1 = [](weight& value) { value = 1e-6; }; //0.1 * value for GW
