...
#ifndef WORD_SPOTTER_CONFIG_HALF_HPP
#define WORD_SPOTTER_CONFIG_HALF_HPP

namespace half {

//#define HALF_CRBM_PMP_1    //One layer of CRBM with Probabilistic Max Pooling (C1)
#define HALF_CRBM_PMP_2 //Two layers of CRBM with Probabilistic Max Pooling (C1/C2)
//#define HALF_CRBM_PMP_3    //Three layers of CRBM with Probabilistic Max Pooling (C1/C2/C3)

//#define HALF_CRBM_MP_1  //One layers of CRBM with Max Pooling after each layer (C1)
...
constexpr const std::size_t B1           = 50;
...
constexpr const std::size_t B2           = 50;
...
const auto rate_0 = [](weight& value) { value = 1.0 * value; };
const auto rate_1 = [](weight& value) { value = 1.0 * value; };
...
const auto pbias_0 = [](weight& value) { value = 0.5 * value; };
const auto pbias_1 = [](weight& value) { value = 0.5 * value; };
