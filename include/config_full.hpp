...
constexpr const std::size_t train_stride = 10;
constexpr const std::size_t test_stride = 10;
...
const auto rate_0 = [](double& value){ value = 0.05 * value; };
const auto rate_1 = [](double& value){ value = 0.1 * value; };
const auto rate_2 = [](double& value){ value = 1.0 * value; };

const auto momentum_0 = [](double& ini, double& fin){ ini = 0.5; fin = 0.9;};
const auto momentum_1 = [](double& ini, double& fin){ ini = 0.5; fin = 0.9;};
